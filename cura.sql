...
INSERT INTO pdf_sizes (routename, length, height) VALUES 
    ...
    ('/reports/orderPaymentList', 35, 20),
    ('/reports/orderReceiptList', 35, 15),
    ('/reports/orderInvoiceList', 45, 14),
    ('/reports/clientReceiptList', 25, 10),
    ('/reports/vendorPaymentsList', 40, 14),
    ...
    ('/reports/orderStaticsView', 20, 10),
    ('/reports/activellagreement', 35, 15),
...
INSERT INTO usertable (id, username, roleid, password, officeid, lobid, usercode, firstname, lastname, status, effectivedate, homephone, workphone, email1, email2, addressline1, addressline2, suburb, city, state, country, zip, dated, createdby, isdeleted, entityid)
VALUES (10, 'test', 5, '$2b$12$997K5.0Z6jllA8PfVkunS.4sfCxOpuPrvZzCEve3VhgoOlRdoWi5q', 2, 14, 'code', 'Defunc', 'User', true, '2024-06-24 00:00:00+05:30', 'f wekjwn  kfw', '', 'test@gmail.com', '', 'ksjf kjwerkw', '', '123', 1751, 'Maharashtra', 5, '96324', '2024-06-25 15:35:55+05:30', 1234, false, 1);
...
INSERT INTO rules (id, module, method, status) VALUES (188, 'reportClientContacts', 'getreportClientContacts', true);
INSERT INTO rules (id, module, method, status) VALUES (189, 'reportOwnerPhoneNos', 'getreportOwnerPhoneNos', true);
INSERT INTO rules (id, module, method, status) VALUES (190, 'reportClientPhoneNos', 'getreportClientPhoneNos', true);
...
INSERT INTO roles_to_rules_map (id, rule_id, role_id) VALUES (463, 186, 1);
INSERT INTO roles_to_rules_map (id, rule_id, role_id) VALUES (464, 187, 1);
INSERT INTO roles_to_rules_map (id, rule_id, role_id) VALUES (465, 188, 1);
INSERT INTO roles_to_rules_map (id, rule_id, role_id) VALUES (466, 189, 1);
INSERT INTO roles_to_rules_map (id, rule_id, role_id) VALUES (467, 190, 1);
